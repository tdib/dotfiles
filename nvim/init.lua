--[[
-- TODO:
-- empty buffer on load (only for opening directories)
--]]
...
What is Kickstart?
  ...
  Kickstart.nvim is a starting point for your own configuration.
    ...
    make Neovim your own! That might mean leaving Kickstart just the way it is for a while or immediately breaking it into modular pieces. It's up to you!
...
-- Set default indentation variables
vim.opt.tabstop = 4
...
-- Let terminal tabs show the active Neovim directory.
vim.opt.title = true
local function set_terminal_title()
  local dir = vim.fn.fnamemodify(vim.fn.getcwd(), ":t")
  vim.opt.titlestring = dir ~= "" and ("nvim (" .. dir .. ")") or "nvim"
end

set_terminal_title()
vim.api.nvim_create_autocmd({ "DirChanged", "VimEnter" }, {
  desc = "Update terminal title with Neovim directory",
...
-- There's a bit of jank here to keep the cursor at its current position, namely the use of marks
vim.keymap.set("i", "<C-/>", "<esc>gcc`^i", { remap = true, desc = "[C]omment line(s)" })
vim.keymap.set("n", "<C-/>", "mqgcc`q", { remap = true, desc = "[C]omment line(s)" })
vim.keymap.set("v", "<C-/>", "gc", { remap = true, desc = "[C]omment line(s)" })

-- Allow shift-tab to unindent in insert mode
...
require("lazy").setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>fi", function()
        ...
        if no_ignore then
          print("Telescope now showing gitignored files")
        else
          print("Telescope now hiding gitignored files")
        end
      end, { desc = "Toggle [I]gnored files in search" })

      vim.keymap.set("n", "<leader>fh", function()
        hidden = not hidden
        if hidden then
          print("Telescope now showing hidden files")
        else
          print("Telescope now hiding hidden files")
        end
      end, { desc = "Toggle [H]idden files in search" })
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        -- Style a single language with a given formatter
        lua = { "stylua" },
...

  {
    ...
    config = function()
      local function on_attach(bufnr)
        ...
        vim.keymap.set("n", "<C-k>", api.tree.change_root_to_parent, opts("Navigate to parent dir"))
        vim.keymap.set("n", "<C-j>", api.tree.change_root_to_node, opts("Navigate to child dir"))
      ...
      vim.keymap.set("n", "<leader>bt", ":NvimTreeFindFile<CR>", { desc = "Find current [B]uffer in file [T]ree" })
    end,
  },
